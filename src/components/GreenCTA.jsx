...
export default function GreenCTA() {
  return (
    <section className="bg-green-600 text-white py-10 px-6 sm:px-10 lg:px-20 text-center h-80 flex flex-col justify-center items-center">
      <h2 className="text-3xl sm:text-4xl lg:text-6xl font-extrabold mb-4">
        Get WhatsApp Solutions that are Scalable as per your Business
        Requirements
      </h2>
      <Button
        type="whiteOutline"
        className="mt-4 font-semibold px-6 py-2 rounded-full shadow hover:bg-gray-100 transition "
        icon={
          <svg
